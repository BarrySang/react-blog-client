...
function Blog ({user, content, likes, comments, title}) {
    // TODO - format likes such that thousands are converted into 'k's
    return (
        <div className="blog-container">
            <p className="blog-user fl-l">{user}</p>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="50" fill="currentColor" className="bi bi-heart" viewBox="0 0 16 16">
                ...
                <text x="8" y="6" fontFamily="Arial" fontSize="5" fill="black" textAnchor="middle" alignmentBaseline="central">{formatNumber(likes)}</text>
            </svg>
            ...
            <p className="blog-comments fl-l">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="43" fill="currentColor" className="bi bi-chat" viewBox="0 0 16 16">
                    ...
                    <text x="8" y="7" fontFamily="Arial" fontSize="5" fill="black" textAnchor="middle" alignmentBaseline="central">{comments}</text>
                </svg>
            </p>
            <div className="clearfix"></div>
        </div>
